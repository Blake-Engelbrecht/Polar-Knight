...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Polar-Knight", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Polar-Knight", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Polar-Knight";
		app.meta["name"] = "Polar-Knight";
